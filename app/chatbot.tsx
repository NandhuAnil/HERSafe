...
import { View, TextInput, Button, ScrollView, Text, StyleSheet, KeyboardAvoidingView, KeyboardAvoidingViewProps, TouchableOpacity } from 'react-native';
...
const ChatApp: FC = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const response = await fetch('https://appsail-50026188699.development.catalystappsail.in/api/chatbot/ask', {
        method: 'POST',
        headers: {
    ...
    <KeyboardAvoidingView style={styles.container} behavior="padding">
      <ScrollView style={styles.messagesContainer}>
        {messages.map((msg, index) => (
          ...
          >
            <Text style={msg.isUser ? styles.userText : styles.botText}>{msg.message}</Text>
          </View>
        ))}
      </ScrollView>
